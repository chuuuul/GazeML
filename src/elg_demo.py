            ...
            while True:
                ...
                for j in range(batch_size):
                    ...
                    if can_use_eye:
                        ...
                        if len(cali.left_iris_captured_data) < 16:
                            left_x_middle = 8
                            right_x_middle = 8
                            y_middle = 3
                            left_dx1 = 42
                            ...
                            left_x_middle = (
                                (cali.right_eyeball_captured_data[1][0] - cali.right_iris_captured_data[1][0]) +
                                (cali.right_eyeball_captured_data[5][0] - cali.right_iris_captured_data[5][0]) +
                                (cali.right_eyeball_captured_data[9][0] - cali.right_iris_captured_data[9][0]) +
                                (cali.right_eyeball_captured_data[13][0] - cali.right_iris_captured_data[13][0]) / 4)
                            right_x_middle = (
                            ...
                            right_dy1 = left_calc_cali(0, 1)
                            right_dy2 = left_calc_cali(1, 1)
                            right_dy3 = left_calc_cali(2, 1)
                            right_dy4 = left_calc_cali(4, 1)
                            right_dy5 = left_calc_cali(5, 1)
                            right_dy6 = left_calc_cali(6, 1)
                            right_dy7 = left_calc_cali(8, 1)
                            right_dy8 = left_calc_cali(9, 1)
                            right_dy9 = left_calc_cali(10, 1)

                        if (-1 * right_gaze_x) < (-1 * left_x_middle) :
                            left_eye_location = 1
                        elif (-1 * left_gaze_x) > right_x_middle :
                            left_eye_location = 3
                        else :
                            left_eye_location = 2
                        ...
                        if (-1 * right_gaze_x < left_x_middle and left_gaze_x < right_x_middle and abs(left_gaze_y) < y_middle) :
                            left_dx = left_dx5
                            right_dx = right_dx5
                            left_dy = left_dy5
                            right_dy = right_dy5
                            point = 5
                        elif right_gaze_x <= -1 * left_x_middle and left_gaze_y <= -1 * y_middle :
                            left_dx = left_dx1
                            right_dx = right_dx1
                            left_dy = left_dy1
                            right_dy = right_dy1
                            point = 1
                        elif right_gaze_x < left_x_middle and left_gaze_x < right_x_middle and left_gaze_y <= -1 * y_middle :
                            left_dx = left_dx2
                            right_dx = right_dx2
                            left_dy = left_dy2
                            right_dy = right_dy2
                            point = 2
                        elif left_gaze_x >= right_x_middle and left_gaze_y <= -1 * y_middle :
                            left_dx = left_dx3
                            right_dx = right_dx3
                            left_dy = left_dy3
                            right_dy = right_dy3
                            point = 3
                        elif right_gaze_x <= -1 * left_x_middle and abs(left_gaze_y) < y_middle :
                            left_dx = left_dx4
                            right_dx = right_dx4
                            left_dy = left_dy4
                            right_dy = right_dy4
                            point = 4
                        elif left_gaze_x >= right_x_middle and abs(left_gaze_y) < y_middle :
                            left_dx = left_dx6
                            right_dx = right_dx6
                            left_dy = left_dy6
                            right_dy = right_dy6
                            point = 6
                        elif right_gaze_x <= -1 * left_x_middle and left_gaze_y >= y_middle :
                            left_dx = left_dx7
                            right_dx = right_dx7
                            left_dy = left_dy7
                            right_dy = right_dy7
                            point = 7
                        elif right_gaze_x < left_x_middle and left_gaze_x < right_x_middle and left_gaze_y >= y_middle :
                            left_dx = left_dx8
                            right_dx = right_dx8
                            left_dy = left_dy8
                            right_dy = right_dy8
                            point = 8
                        elif left_gaze_x >= right_x_middle and left_gaze_y >= y_middle :
                            left_dx = left_dx9
                            right_dx = right_dx9
                            left_dy = left_dy9
                            right_dy = right_dy9
                    ...
                    if eye_index == len(frame['eyes']) - 1:
                        ...
                        if frame_index % 10 == 0:
                            ...
                            print("point : ", point)
                            if len(cali.left_iris_captured_data) > 15:
                                print("left_x_middle : ", left_x_middle)
                                print("right_x_middle : ", right_x_middle)
                                print("location : ", left_gaze_x)
                                print("location : ", right_gaze_x)
